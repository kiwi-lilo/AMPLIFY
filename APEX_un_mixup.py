...
class pretraining_model(nn.Module):
    def __init__(self,
        ...
        if 'roberta_base' in self.model_name_or_path:
            ...
            self.model = BertForSequenceClassification.from_pretrained(f"{self.model_name_or_path}", num_labels=num_labels)
...
def main(cfg: DictConfig) -> None:
    ...
    Config.basic.logging_dir = f'{root_dir}/{Config.basic.task_name}/log/{Config.model.model_name}/wm_{Config.model.num_warmup_steps}_wd_{Config.model.weight_decay}_{Config.trainer.train_batch_size}_{Config.model.max_seq_length}_{Config.trainer.limit_train_batches}_{Config.model.forward_type}'              
    Config.basic.checkpoint_path = f'{root_dir}/{Config.basic.task_name}/models/{Config.model.model_name}/wm_{Config.model.num_warmup_steps}_wd_{Config.model.weight_decay}_{Config.trainer.train_batch_size}_{Config.model.max_seq_length}_{Config.trainer.limit_train_batches}_{Config.model.forward_type}'       
    Config.basic.profiler_path = f'{root_dir}/{Config.basic.task_name}/profiler/{Config.model.model_name}/wm_{Config.model.num_warmup_steps}_wd_{Config.model.weight_decay}_{Config.trainer.train_batch_size}_{Config.model.max_seq_length}_{Config.trainer.limit_train_batches}_{Config.model.forward_type}'
    if Config.trainer.auto_lr_find == True and Config.trainer.use_swa == False:
        Config.basic.logging_dir = f'{root_dir}/{Config.basic.task_name}/log/{Config.model.model_name}/lr_wm_{Config.model.num_warmup_steps}_wd_{Config.model.weight_decay}_{Config.trainer.train_batch_size}_{Config.model.max_seq_length}_{Config.trainer.limit_train_batches}_{Config.model.forward_type}'              
        Config.basic.checkpoint_path = f'{root_dir}/{Config.basic.task_name}/models/{Config.model.model_name}/lr_wm_{Config.model.num_warmup_steps}_wd_{Config.model.weight_decay}_{Config.trainer.train_batch_size}_{Config.model.max_seq_length}_{Config.trainer.limit_train_batches}_{Config.model.forward_type}'       
        Config.basic.profiler_path = f'{root_dir}/{Config.basic.task_name}/profiler/{Config.model.model_name}/lr_wm_{Config.model.num_warmup_steps}_wd_{Config.model.weight_decay}_{Config.trainer.train_batch_size}_{Config.model.max_seq_length}_{Config.trainer.limit_train_batches}_{Config.model.forward_type}'
    elif Config.trainer.use_swa == True and Config.trainer.auto_lr_find == False:
        Config.basic.logging_dir = f'{root_dir}/{Config.basic.task_name}/log/{Config.model.model_name}/swa_wm_{Config.model.num_warmup_steps}_wd_{Config.model.weight_decay}_{Config.trainer.train_batch_size}_{Config.model.max_seq_length}_{Config.trainer.limit_train_batches}_{Config.model.forward_type}'              
        Config.basic.checkpoint_path = f'{root_dir}/{Config.basic.task_name}/models/{Config.model.model_name}/swa_wm_{Config.model.num_warmup_steps}_wd_{Config.model.weight_decay}_{Config.trainer.train_batch_size}_{Config.model.max_seq_length}_{Config.trainer.limit_train_batches}_{Config.model.forward_type}'       
        Config.basic.profiler_path = f'{root_dir}/{Config.basic.task_name}/profiler/{Config.model.model_name}/swa_wm_{Config.model.num_warmup_steps}_wd_{Config.model.weight_decay}_{Config.trainer.train_batch_size}_{Config.model.max_seq_length}_{Config.trainer.limit_train_batches}_{Config.model.forward_type}'
    elif Config.trainer.use_swa == True and Config.trainer.auto_lr_find == True:
        Config.basic.logging_dir = f'{root_dir}/{Config.basic.task_name}/log/{Config.model.model_name}/lr_swa_wm_{Config.model.num_warmup_steps}_wd_{Config.model.weight_decay}_{Config.trainer.train_batch_size}_{Config.model.max_seq_length}_{Config.trainer.limit_train_batches}_{Config.model.forward_type}'              
        Config.basic.checkpoint_path = f'{root_dir}/{Config.basic.task_name}/models/{Config.model.model_name}/lr_swa_wm_{Config.model.num_warmup_steps}_wd_{Config.model.weight_decay}_{Config.trainer.train_batch_size}_{Config.model.max_seq_length}_{Config.trainer.limit_train_batches}_{Config.model.forward_type}'       
        Config.basic.profiler_path = f'{root_dir}/{Config.basic.task_name}/profiler/{Config.model.model_name}/lr_swa_wm_{Config.model.num_warmup_steps}_wd_{Config.model.weight_decay}_{Config.trainer.train_batch_size}_{Config.model.max_seq_length}_{Config.trainer.limit_train_batches}_{Config.model.forward_type}'
        ...
        if 'test' in Config.basic.train_type:
            ...
            if 'save_prediction' in Config.basic.train_type:
                ...
                with torch.no_grad():
                    ...
                    np.save(f'{Config.basic.checkpoint_path}/{Config.basic.task_name}_{Config.trainer.limit_train_batches}_{Config.trainer.train_batch_size}_{Config.model.max_seq_length}_{Config.model.model_name}_test_predictions.npy', tta_y_pred_logits)
                    #get final acc
                    ...
                    final_results.to_csv(f'{root_dir}/TTA/{Config.basic.task_name}_{Config.trainer.limit_train_batches}_{Config.trainer.train_batch_size}_{Config.model.max_seq_length}_{Config.model.model_name}_test_results.csv', index=False)
